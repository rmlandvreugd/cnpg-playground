...
# SeaweedFS Configuration (Loki-only object store, weed mini all-in-one)
...
SEAWEEDFS_VOLUME_PORT="${SEAWEEDFS_VOLUME_PORT:-9340}" # Volume server (mini default)
SEAWEEDFS_FILER_PORT="${SEAWEEDFS_FILER_PORT:-8888}"   # Filer UI + API
SEAWEEDFS_ADMIN_PORT="${SEAWEEDFS_ADMIN_PORT:-23646}"  # Admin UI
