...
AUTHELIA_ZOT_CLIENT_SECRET="${AUTHELIA_ZOT_CLIENT_SECRET:-zot-oidc-demo-secret}"
...
TRUST_MANAGER_CHART_VERSION="${TRUST_MANAGER_CHART_VERSION:-0.25.0}"
METRICS_SERVER_CHART_VERSION="${METRICS_SERVER_CHART_VERSION:-3.14.0}"
KUBELET_CSR_APPROVER_CHART_VERSION="${KUBELET_CSR_APPROVER_CHART_VERSION:-1.2.15}"
...
CAPSULE_PROXY_CHART_VERSION="${CAPSULE_PROXY_CHART_VERSION:-0.14.1}"
...
POLICY_REPORTER_CHART_VERSION="${POLICY_REPORTER_CHART_VERSION:-3.10.0}"
# Argo Ecosystem
ARGOCD_CHART_VERSION="${ARGOCD_CHART_VERSION:-10.9.2}"
ARGO_WORKFLOWS_CHART_VERSION="${ARGO_WORKFLOWS_CHART_VERSION:-2.0.7}"
ARGO_EVENTS_CHART_VERSION="${ARGO_EVENTS_CHART_VERSION:-2.4.27}"
ARGO_ROLLOUTS_CHART_VERSION="${ARGO_ROLLOUTS_CHART_VERSION:-2.43.2}"
...
BARMAN_CLOUD_PLUGIN_CHART_VERSION="${BARMAN_CLOUD_PLUGIN_CHART_VERSION:-0.8.0}"
GRAFANA_OPERATOR_CHART_VERSION="${GRAFANA_OPERATOR_CHART_VERSION:-5.25.0}"
KUBE_PROMETHEUS_STACK_CHART_VERSION="${KUBE_PROMETHEUS_STACK_CHART_VERSION:-91.4.1}"
